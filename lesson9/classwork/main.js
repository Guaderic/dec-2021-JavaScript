...
for (const item of coursesArray) {
    ...
    monthDiv.innerText = `month duration - ${item.monthDuration}`;

    document.body.append(hourDiv);
    hourDiv.innerText = ` hour duration - ${item.hourDuration}`;

    document.body.append(modulesUl);
    modulesUl.innerText = `MODULES:`
