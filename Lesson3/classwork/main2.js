...
/*for (i=0; i < simpsons.length; i++){
    document.write(`<div id="simpson">${simpsons[i].name} - 
                   ${simpsons[i].surname} -
                   ${simpsons[i].age} - 
                   ${simpsons[i].info} - 
...
for (let i = 0; i < simpsons.length; i++) {
     document.write(`<div class = 'smp'">
                        <h2 id = name>${simpsons[i].name} ${simpsons[i].surname}. Age is - ${simpsons[i].age}</h2>
                        <p>${simpsons[i].info} </p>
                         <img id="image" src="${simpsons[i].photo}" alt="${simpsons[i].name}">
                    </div>`);
 }
*/
...
//                          <img class="image" src="${products[i].image}" alt="${products[i].title}"></div>`)
//     }
